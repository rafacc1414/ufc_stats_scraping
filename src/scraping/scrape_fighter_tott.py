...
# write to file
all_fighter_details_df.to_csv(
    f"{dirname}/../../data/{config['fighter_details_file_name']}", index=False
)
...
# write to file
all_fighter_tott_df.to_csv(
    f"{dirname}/../../data/{config['fighter_tott_file_name']}", index=False
)
